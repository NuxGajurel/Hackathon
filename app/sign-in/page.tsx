      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-[#3B4D5E] mb-2">
            Welcome <span className="text-[#48C78E] italic">Back</span>
          </h1>
          <p className="text-[#6A7C8E]">
            Sign in to continue to SaralSewa
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label htmlFor="password" className="block text-sm font-medium text-[#3B4D5E]">
                  Password
                </label>
                <Link href="/forgot-password" className="text-sm text-[#48C78E] hover:underline">
                  Forgot password?
                </Link>
              </div>
              <input
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={handleChange}
                className="w-4 h-4 text-[#48C78E] border-gray-300 rounded focus:ring-[#48C78E]"
              />
              <label htmlFor="rememberMe" className="ml-2 text-sm text-[#6A7C8E]">
                Remember me
              </label>
            </div>
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg font-medium text-[#3B4D5E] hover:bg-gray-50 transition flex items-center justify-center gap-2"
            >
          ...
          <div className="text-center">
            <p className="text-[#6A7C8E]">
              ...
              <Link href="/sign-up" className="text-[#48C78E] font-semibold hover:underline">
                Sign Up
              </Link>
            </p>
          </div>
